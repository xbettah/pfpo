...
public class Agenda extends AgendaAbstracta{
	...
	for (ContactoInterfaz contacto: listaContactos){
	    System.out.println(contacto.getPersona().getPrimerApellido()+" "+contacto.getPersona().getSegundoApellido()+" "+contacto.getPersona().getNombre()+" "+contacto.getTelefono().getTelefono());
	}
    }
    ...
    public void ordenarContactosPorTelefono(){
	Comparator<ContactoInterfaz> comparar = new OrdenacionTelefono();
	Collections.sort(listaContactos,comparar);
    }
